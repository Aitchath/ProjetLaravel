...
<nav class="border bg-white h-24">
    <div class="flex items-stretch justify-center p-8 ">
        <div class="font-semibold text-lg mr-2"> <a href="{{route('Commerce.index')}}"> Accueil </a>  </div>
        <div class="font-semibold text-lg ml-4">Qui sommes-nous?</div>
        <div class="font-semibold text-lg ml-6">Nos services</div>
        <div class="font-semibold text-lg ml-8"> <a href="{{route('Commerce.ajout')}}"> Actualité </a> </div>
        <div class="font-semibold text-lg ml-10">Contactez-nous</div>
        <div class="border-2 rounded-full py-3 px-6 mb-8 w-50 h-14 bg-blue-400 font-semibold text-white ml-12 mb-8">  <button> <a href="{{route('Commerce.ajout')}}"> Ajouter un produit </a> </button>  </div>  
        <div class="rounded-lg w-1.5/12 flex  py-3 px-6 h-12 bg-gray-100 ml-14 p-8">  
            ...
            <div class="mb-2 rounded-full bg-black w-9 h-9 text-white text-2xl font-bold px-3 ml-4">0</div>
        </div>  
    </div>
    </nav>
